...
export function AdmittedStudentTable({
  ...
  return (
    <Card>
      <CardHeader>
          <CardTitle>Newly Admitted Students</CardTitle>
          <CardDescription>A list of students whose applications have been accepted.</CardDescription>
      </CardHeader>
      <CardContent>
